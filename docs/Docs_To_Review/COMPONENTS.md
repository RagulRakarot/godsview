# Component Documentation — Godsview
...
Godsview's UI is built entirely with **vanilla TypeScript** — no React, Vue, or
...
Godsview ships two independent map renderers and an adapter that picks the
