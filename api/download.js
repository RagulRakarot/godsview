...
const RELEASES_URL = 'https://api.github.com/repos/RagulRakarot/Godsview/releases/latest';
const RELEASES_PAGE = 'https://github.com/RagulRakarot/Godsview/releases/latest';
