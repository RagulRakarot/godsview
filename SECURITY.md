...
If you discover a security vulnerability in Godsview, please report it responsibly:

1. **GitHub Private Vulnerability Reporting**: Use [GitHub's private vulnerability reporting](https://github.com/RagulRakarot/Godsview/security/advisories/new) to submit your report directly through the repository.

2. **Direct Contact**: Alternatively, reach out to the project maintainer directly through GitHub.
...
Godsview is a client-side intelligence dashboard that aggregates publicly available data. Here are the key security areas:
...
- Godsview aggregates publicly available OSINT data
...
- Vulnerabilities in the Godsview codebase
...
Thank you for helping keep Godsview and its users safe! 🔒
