// Dynamic Meta Tags Service for Godsview
...
const BASE_URL = 'https://godsview.app';
const DEFAULT_IMAGE = 'https://godsview.app/favico/og-image.png';
...
export function updateMetaTagsForStory(meta: StoryMeta): void {
  ...
  const title = `${countryName} Intelligence Brief | Godsview`;
...
export function resetMetaTags(): void {
  const defaultTitle = 'Godsview - Global Situation with AI Insights';
...
function generateDescription(
  ...
  return `Godsview ${parts.join('. ')}. Free, open-source geopolitical intelligence.`;
}
