# Contributing to Godsview

Thank you for your interest in contributing to Godsview! This project thrives on community contributions — whether it's code, data sources, documentation, or bug reports.
...
Godsview is a real-time OSINT dashboard built with **Vanilla TypeScript** (no UI framework), **MapLibre GL + deck.gl** for map rendering, and a custom Proto-first RPC framework called **Sebuf** for all API communication.
...
- **Internationalization** — help make Godsview available in more languages
...
Use the [Bug Report issue template](https://github.com/RagulRakarot/Godsview/issues/new/choose) when available.
...
Use the [Feature Request issue template](https://github.com/RagulRakarot/Godsview/issues/new/choose) when available.
...
Thank you for helping make Godsview better! 🌍
